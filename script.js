...
let startScreen = document.querySelector("Start_btn");
let startButton = document.getElementById("start-button");
const exit_btn = info_box.querySelector(".buttons .exit_quit");
...
ScrollReveal({ 
  ...
  ScrollReveal().reveal('.Start_btn', { delay: 300, origin: 'left' });
//   ScrollReveal().reveal('button', { delay: 300, origin: 'left' });
